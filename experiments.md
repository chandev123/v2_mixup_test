...
| 3 | 2025-11-28 | Mixup 시각화 구현 | 완료 | 원본 vs Mixup 비교 및 학습 중 스냅샷 저장 |
...
#### 목표
- Mixup이 적용된 이미지를 눈으로 직접 확인
- 원본 이미지와 Mixup된 이미지를 비교하여 라벨 혼합 비율 확인
- 학습 과정(Epoch 1) 중에 실제로 적용되는 Mixup 데이터 캡처
